...
window.actionRequestAction = actionRequestAction;
window.revokeRequestAction = revokeRequestAction;
window.viewAssetDetails = viewAssetDetails;
window.closeModal = closeModal;
window.openModal = openModal;
window.switchDetailTab = switchDetailTab;
window.exportAssetRegisterPDF = exportAssetRegisterPDF;
window.exportAssetRegisterCSV = exportAssetRegisterCSV;
window.filterAssetTable = filterAssetTable;
window.openRegisterAssetModal = openRegisterAssetModal;
window.openBulkImportModal = openBulkImportModal;
window.openAssignAssetModal = openAssignAssetModal;
