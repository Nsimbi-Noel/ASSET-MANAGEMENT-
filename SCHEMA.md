...
| `assigned_to` | INTEGER | FOREIGN KEY (users.id) | User assigned the asset |
...
| `asset_id` | TEXT | FOREIGN KEY (assets.id) | Linked asset |
| `from_user_id` | INTEGER | FOREIGN KEY (users.id) | Previous assignee |
| `to_user_id` | INTEGER | FOREIGN KEY (users.id) | New assignee |
